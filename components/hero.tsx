...
export default function Hero(){
    return (
        ...
        <div className="h-full flex justify-center items-center pb-12 ">
            ...
            <span className="mx-auto text-6xl text-[#121212] font-bold tracking-tighter">Convert videos online, <span className=" text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-purple-400 to-pink-400">
                Instantly</span></span>
            <span className="mx-auto text-2xl text-neutral-600 pt-3 ">
                Powerful browser-based converting tool for linux users and everyone.
            </span>
            <span className="mx-auto text-md text-neutral-500 w-2/5 text-center mt-6">Easily convert video from one format to any other format with ease and just one click. Helps mainly linux users for screen recordings conversion. Built using FFMPEG Web Assembly.</span>
      ...
      <div className="h-fit w-full flex justify-center items-center mb-20">
        <div className="flex flex-col items-center">
            <p className="text-3xl font-bold tracking-wide pb-4">Endless Customisations</p>
            <p className="text-wrap w-[30vw] text-center text-sm text-neutral-500 mb-5">You can choose from many options that are available including framerate, video quality and many more..</p>
            <div className="my-5 h-fit w-fit flex justify-center p-2 hover:scale-105 duration-300">
                <SmallCard icon={<FileVideo2 className="size-10" />} header={'Customise your framerate accordingly'} text="You can customise the framerate you want to transcode your video into by giving the number"/>
            </div>
            <div className="my-5 h-fit w-fit flex justify-center p-2 hover:scale-105 duration-300  ">
                <SmallCard icon={<Videotape className="size-10" />} header={'Different video quality'} text="You can choose from four different video qualities you want to transcode your video into by giving the number"/>
            </div>
            <div className="my-5 h-fit w-fit flex justify-center p-2 hover:scale-105 duration-300  ">
